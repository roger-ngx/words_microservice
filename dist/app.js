...
var httpServer = http.createServer(app); // view engine setup
...
app.use('/api/file/delete', fileDeleteRouter); // catch 404 and forward to error handler
...
console.log("server is running on port ".concat(process.env.HTTPS_PORT, " for https and ").concat(process.env.HTTP_PORT, " for http"));
module.exports = app;